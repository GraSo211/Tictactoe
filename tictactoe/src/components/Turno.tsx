    ...
    return(
        <>
            <div className={"self-start flex gap-2 flex-col justify-center items-center  text-[#D4C9BE]    "}>
                ...
                <div className={seleccionado === jugadorNombre ? "p-1  bg-[#123458] border-gray-800 border  rounded-2xl" : "p-1  border border-transparent  rounded-2xl "}>
                    <span className="size-80">{signo}</span>
                </div>
            </div>
