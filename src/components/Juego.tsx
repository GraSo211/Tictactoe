...
export default function Juego() {
    ...
    const circle =  <svg version="1.1" id="Layer_1_1_" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 16 16" width="150px" height="150px">
                        <circle cx="8" cy="8" r="8" fill="#0074ba"/>
                    </svg>
    const cross =   <svg version="1.1" id="cross-11" xmlns="http://www.w3.org/2000/svg" width="150px" height="150px" viewBox="0 0 11 11" >
    ...
    const checkearVictoria = (array: SVGAElement[], turno: Jugadores) => {
    ...
    function marcarCasilla(celda: number) {
        ...
        if (turno === "jugador1") {
            nuevoArray[celda] = circle
            setTurno("jugador2");
        } else {
            nuevoArray[celda] =  cross
            setTurno("jugador1");
        }
        setArray(nuevoArray);
